...
export type ReservationCollectionResponse =
  StrapiCollectionResponse<Reservation>
...
export type BlockedSlotCollectionResponse =
  StrapiCollectionResponse<BlockedSlot>

/**
 * Reservation Config (single type)
 */
